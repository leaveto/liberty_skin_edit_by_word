...
class SkinLiberty extends SkinTemplate {
	...
	public function initPage( OutputPage $out ) {
		...
		$mainColor = isset( $GLOBALS['#fff8dc'] ) ? $GLOBALS['#fff8dc'] : '#fff8dc';
		$ogLogo = isset( $GLOBALS['wgLibertyOgLogo'] ) ? $GLOBALS['wgLibertyOgLogo'] : $wgLogo = "$wgserver/boseong.png";
			...
			$out->addHeadItem(
				...
				<script>
				  (adsbygoogle = window.adsbygoogle || []).push({
					google_ad_client: "ca-pub-4847028212662633",
